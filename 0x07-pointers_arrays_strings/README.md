...
You don퓍 have to push _putchar.c, we will use our file. If you do it won퓍 be taken into account
In the following examples, the main.c files are shown as examples. You can use them to test your functions, but you don퓍 have to push them to your repo (if you do we won퓍 take them into account). We will use our own main.c files at compilation. Our main.c files might be different from the one shown in the examples
The prototypes of all your functions and the prototype of the function _putchar should be included in your header file called main.h
Don퓍 forget to push your header file
More Info
